...
'''4-13 tuple buffet'''
buffet = ("Oksetyndsteg med fuglegræs, syltede skalotter og timianstøv", "Rødvinssauce med madargaskarpeber", "Honningglasserede gulerødder med salvie", "ovnstegte kartofler vendt i mos og olivenolie", "Bagte tomater, semidried, thai basilikum og emmenthaler")
print("Buffet:")
...
#menu change
buffet = ("Sprængt kalkun cuvette, syltede skalotter og grillet citron", "Skysauce med madargaskarpeber", "Honningglasserede gulerødder med salvie", "ovnstegte kartofler vendt i mos og olivenolie", "Bagte tomater, semidried, thai basilikum og emmenthaler")
print("Buffet:")
for element in buffet:
    print(element)
print("\n")